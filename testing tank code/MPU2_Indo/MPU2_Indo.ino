...
void loop() {
  ...
  GyroX = GyroX - 1.39;          //0.74;  
  GyroY = GyroY + 0.48;          //0.66;  
  ...
  // Nilai Output dikoreksi dengan dijumlahkan dengan nilai yg didapat dari void calculate_IMU_error()
  GyroX2 = GyroX2 + 0.76;//5.44;          //  
  GyroY2 = GyroY2 + 0.67;//0.11;          //  
  ...
  int servo0Value1 = map(servo0Value, -90,90,180,0); // dimaping untuk mulai pada sudut 90 derajat
  int servo1Value1 = map(servo1Value, -90,90,180,0);
  int servo2Value1 = map(servo2Value, -90,90,180,0);
//  servo0Value1 =servo0Value1 +30;
 ...
 // }
  ...
  int gyro0Value2 = map(gyro0Value1, -90, 90, 180, 0); //90-->22 == 4x lipat
  int gyro1Value2 = map(gyro1Value1, -90, 90, 180, 0);
  int gyro2Value2 = map(gyro2Value1, -90, 90, 180, 0);
  //----------------------------------------------------------
